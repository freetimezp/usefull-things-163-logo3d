...
document.addEventListener("DOMContentLoaded", () => {
    ...
    cubesFaces.forEach((face) => {
        ...
        img.src = `./assets/images/img${imageCounter}.jpg`;
        img.alt = "";
        ...
        onUpdate: (self) => {
          ...
          const cubesOpacityProgress =
            self.progress >= 0.01
              ...
              : 0;
          cubesContainer.style.opacity = cubesOpacityProgress; //can show 1
          ...
          header1.style.filter = `blur(${interpolate(
            0,
            20,
            header1Progress
          )}px)`;
          header1.style.opacity = 1 - header1Progress; //can show 2
          ...
          header2.style.opacity = header2Progress; //can show 3
